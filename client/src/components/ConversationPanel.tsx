...
export default function ConversationPanel({
  ...
  return (
    <div className="w-full h-full bg-slate-800/50 backdrop-blur-sm border-t lg:border-l lg:border-t-0 border-slate-700 flex flex-col">
      {/* Panel Header */}
      ...
      <div 
        ref={scrollRef}
        className="flex-1 p-4 overflow-y-auto conversation-scroll min-h-0"
      >
              ...
              <div key={index} className="flex items-start space-x-3 animate-in fade-in duration-300">
                ...
                <div className="flex-1 min-w-0">
                  <div className="bg-slate-700/50 rounded-lg px-4 py-3">
                    <p className="text-sm text-slate-200 break-words">{message.content}</p>
                  </div>
        ...
        {currentTranscription && (
          <div className="mt-4 p-3 bg-blue-900/20 border border-blue-800/30 rounded-lg">
            ...
            <p className="text-sm text-slate-300 italic break-words">{currentTranscription}</p>
          </div>
        )}
      </div>
      ...
      <div className="p-4 border-t border-slate-700 flex-shrink-0">
        <div className="space-y-3">
          <label className="text-sm font-medium text-slate-300">Manual Input</label>
